...
- Additional node types (Journal, Institution)
- New edge types (Citation, Topic tags)
...
```bibtex
@software{ontological_generalization_framework,
  title={Ontological Generalization Framework for Text-Augmented Graphs},
  author={Your Name},
  year={2026},
  url={https://github.com/yourusername/SocialAnalysis}
}
```
...
- Built on top of PyTorch Geometric
